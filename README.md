...
For this assignment, you will be creating a **two-model CRUD application** with Mongoose & MongoDB where users can post photos.  It is intended to take 2 days....  We will continue discussing two-model CRUD apps, and techniques for connecting the two models next week.
